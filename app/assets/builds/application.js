...
// app/javascript/controllers/market_data_controller.js
var market_data_controller_default = class extends Controller {
  static targets = ["price", "change", "volume"];
  static values = {
    securityId: Number
  };
  connect() {
    this.channel = createConsumer3().subscriptions.create(
...
application.register("market-data", market_data_controller_default);
